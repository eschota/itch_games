export declare const GAME_VERSION = "v0.0.055";
...
export declare const KICK_RANGE = 1.25;
export declare const FOOT_KICK_ASSIST_RANGE = 1.35;
...
export declare const BALL_POSSESSION_BASE_POWER_MULTIPLIER = 1.2;
